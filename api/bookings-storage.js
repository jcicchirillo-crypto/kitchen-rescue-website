        ...
        try {
            ...
            const mappedData = (data || []).map(booking => {
                ...
                return {
                    ...
                    quote_sent_at: booking.quote_sent_at || booking.quoteSentAt || null,
                    follow_up_at: booking.follow_up_at || booking.followUpAt || null,
                    follow_up_status: booking.follow_up_status || booking.followUpStatus || null,
                    follow_up_reminder_sent_at: booking.follow_up_reminder_sent_at || booking.followUpReminderSentAt || null,
            ...
            const insertAttempts = [
                {
                    ...
                    payload: cleanPayload({
                        ...
                        follow_up_reminder_sent_at: newBooking.followUpReminderSentAt || newBooking.follow_up_reminder_sent_at || null,
                    }),
                },
                {
                ...
                {
                    label: 'snake_case_core_no_source',
                    payload: cleanPayload({
                        booking_reference: newBooking.id,
                        customer_name: newBooking.name || 'Enquiry',
                        customer_email: newBooking.email || '',
                ...
                },
                {
                    ...
                    payload: cleanPayload({
                        ...
                        status: newBooking.status || 'Awaiting deposit',
                        source,
                        quoteSentAt: newBooking.quoteSentAt || newBooking.quote_sent_at || null,
                        followUpAt: newBooking.followUpAt || newBooking.follow_up_at || null,
                        followUpStatus: newBooking.followUpStatus || newBooking.follow_up_status || null,
                        followUpReminderSentAt: newBooking.followUpReminderSentAt || newBooking.follow_up_reminder_sent_at || null,
                        createdAt: newBooking.createdAt || new Date().toISOString(),
                    }),
                },
                {
                    label: 'camelCase_no_source',
                    payload: cleanPayload({
                        id: newBooking.id,
                        name: newBooking.name || 'Enquiry',
                        email: newBooking.email || '',
